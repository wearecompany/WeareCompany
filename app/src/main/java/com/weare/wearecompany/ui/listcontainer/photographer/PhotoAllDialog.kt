...
class PhotoAllDialog(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.addFragment(PhotoCategoryFragment(), "카테고리")
        adapter.addFragment(PhotoLocationFragment(), "위치")
        adapter.addFragment(PhotoMoneyFragment(), "금액대")
        adapter.addFragment(PhotoSortFragment(), "조회순")
