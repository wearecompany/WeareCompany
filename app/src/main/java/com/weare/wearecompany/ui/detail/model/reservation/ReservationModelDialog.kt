...
class ReservationModelDialog (val reserve_dt:ArrayList<String>, val reserve_time:Int,  val reserve_contents:String,  val itemClick:(Int) -> Unit): DialogFragment() {
    ...
    val size = Point()
    private lateinit var dateadapter : ReservationModelDialogRecyclerViewAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        display.getSize(size)
            ...
            dateadapter = ReservationModelDialogRecyclerViewAdapter(reserve_dt)
            ...
            view.Re_expert_people_layout.visibility = View.GONE
