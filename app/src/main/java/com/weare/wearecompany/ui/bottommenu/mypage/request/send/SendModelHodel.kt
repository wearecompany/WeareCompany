...
import com.weare.wearecompany.ui.bottommenu.mypage.request.SendOneRecyclerViewAdapter
import java.text.DecimalFormat

class SendModelHodel(v: View) : RecyclerView.ViewHolder(v) {

    private val clip = itemView.findViewById<RecyclerView>(R.id.request_model_list_recyclerview)
    private val money_layout = itemView.findViewById<LinearLayout>(R.id.request_model_list_money_layout)
    private val call_time = itemView.findViewById<TextView>(R.id.request_model_call_time)
    private val name = itemView.findViewById<TextView>(R.id.request_model_name)
    val purchase = itemView.findViewById<TextView>(R.id.request_model_purchase_btn)
    val review = itemView.findViewById<TextView>(R.id.request_model_review_btn)
    private val money = itemView.findViewById<TextView>(R.id.request_model_list_money)
    private val money_title_1 = itemView.findViewById<TextView>(R.id.request_model_list_money_title_1)
    private val money_title_2 = itemView.findViewById<TextView>(R.id.request_model_list_money_title_2)
