...
class EstimateDatailViewHodel(v: View):RecyclerView.ViewHolder(v) {
    ...
    fun bindWithView(Item: Uri, postion:Int, context:Context, onClickListener: View.OnClickListener) {
