...
import com.weare.wearecompany.databinding.ActivityReceivePhotoBinding
...
class ReceivePhotoActivity : BaseActivity<ActivityReceivePhotoBinding>(
    R.layout.activity_receive_photo
            ...
            completion = { responseStatus, data ->
                when (responseStatus) {
                    ESTIMATE.OKAY -> {
                        ...
                        mViewDataBinding.receivePhotoExpertName.text = data[0].expert_name
                        mViewDataBinding.receivePhotoExpertPlace.text = data[0].expert_place
                        mViewDataBinding.receivePhotoExpertPrice.text = data[0].expert_price
                        ...
                        mViewDataBinding.receivePhotoExpertCategoryRecyclerview.layoutManager =
                            LinearLayoutManager(
                                this,
                                LinearLayoutManager.HORIZONTAL, false
                            )
                        mViewDataBinding.receivePhotoExpertCategoryRecyclerview.adapter = tagAdapter
                        ...
                        Glide.with(MyApplication.instance)
                            ...
                            .into(mViewDataBinding.receivePhotoExpertImage)


                        mViewDataBinding.receivePhotoExpertDt.text = data[0].reserve_dt
                        mViewDataBinding.receivePhotoExpertTime.text =
                            data[0].reserve_time.toString()
                        mViewDataBinding.receivePhotoExpertTimezone.text = data[0].reserve_time_term
                        mViewDataBinding.receivePhotoExpertHeadcount.text =
                            data[0].reserve_headcount.toString()

                        mViewDataBinding.receivePhotoExpertContents.text = data[0].reserve_contents

                        if (data[0].reserve_add_contents != "") {
                            mViewDataBinding.receivePhotoExpertAddContentsLayout.visibility =
                                View.VISIBLE
                            mViewDataBinding.receivePhotoExpertAddContents.text =
                                data[0].reserve_add_contents
                        }
                        mViewDataBinding.receivePhotoFinalPrice.text =
