...
import com.weare.wearecompany.databinding.ActivityProgressShopBinding
...
class ProgressShopActivity : BaseActivity<ActivityProgressShopBinding>(
    R.layout.activity_progress_shop
            ...
            completion = { responseStatus, data ->
                when (responseStatus) {
                    ESTIMATE.OKAY -> {
                        ...
                        mViewDataBinding.progressShopName.text = data[0].expert_name
                        mViewDataBinding.progressShopExpertUserName.text = data[0].expert_user_name
                        ...
                        Glide.with(MyApplication.instance)
                            ...
                            .into(mViewDataBinding.progressShopImage)
                        ...
                        mViewDataBinding.progressShopCategoryRecyclerview.layoutManager = LinearLayoutManager(
                            this,
                            LinearLayoutManager.HORIZONTAL, false
                        )
                        mViewDataBinding.progressShopCategoryRecyclerview.adapter = tagAdapter
