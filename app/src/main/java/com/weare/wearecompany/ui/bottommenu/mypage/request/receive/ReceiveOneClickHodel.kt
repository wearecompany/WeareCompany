...
class ReceiveOneClickHodel(v: View) : RecyclerView.ViewHolder(v) {
    ...
    val purchase = itemView.findViewById<TextView>(R.id.request_list_onclick_purchase_btn)
    ...
    fun bindWithView(item: receiveoneclick, postion:Int, context:Context, type:Int, onClickListener: View.OnClickListener) {
