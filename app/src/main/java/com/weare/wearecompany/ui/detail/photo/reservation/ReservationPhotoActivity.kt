...
class ReservationPhotoActivity: BaseActivity<ActivityReservationExpertBinding>(
            ...
            R.id.expert_ok -> {
                daylist = ArrayList<String>()
                    ...
                    if (mViewDataBinding.calendarView.selectedDates.size == 0) {
                        ...
                        val photoDialog: ReservationPhotoDialog = ReservationPhotoDialog(daylist,mViewDataBinding.expertTime.text.toString().toInt(), mViewDataBinding.expertPeople.text.toString().toInt(),mViewDataBinding.expertContents.text.toString()) {
                            when(it) {
                                1 -> {
                        ...
                        photoDialog.isCancelable = false
