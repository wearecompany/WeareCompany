...
class SendStudioViewHodel(v: View) : RecyclerView.ViewHolder(v) {

    private val send_time = itemView.findViewById<TextView>(R.id.send_studio_call_time)
    private val room = itemView.findViewById<TextView>(R.id.send_studio_room_name)
    private val recyclerView = itemView.findViewById<RecyclerView>(R.id.send_studio_recyclerview)
