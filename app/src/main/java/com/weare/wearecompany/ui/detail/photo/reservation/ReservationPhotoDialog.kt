...
class ReservationPhotoDialog( val reserve_dt:ArrayList<String>, val reserve_time:Int, val reserve_headcount:Int, val reserve_contents:String,  var itemClick:(Int) -> Unit): DialogFragment() {
    ...
    val size = Point()
    private lateinit var dateadapter : ReservationPhotoDialogRecyclerViewAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        display.getSize(size)
            ...
            dateadapter = ReservationPhotoDialogRecyclerViewAdapter(reserve_dt)
