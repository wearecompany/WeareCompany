...
import com.weare.wearecompany.databinding.ActivityReceiveTripBinding
...
class ReceiveTripActivity : BaseActivity<ActivityReceiveTripBinding>(
    R.layout.activity_receive_trip
            ...
            completion = { responseStatus, data ->
                when (responseStatus) {
                    ESTIMATE.OKAY -> {
                        ...
                        mViewDataBinding.receiveTripExpertName.text = data[0].expert_name
                        mViewDataBinding.receiveTripExpertPlace.text = data[0].expert_place
                        mViewDataBinding.receiveTripExpertPrice.text = data[0].expert_price
                        ...
                        mViewDataBinding.receiveTripExpertCategoryRecyclerview.layoutManager =
                            LinearLayoutManager(
                                this,
                                LinearLayoutManager.HORIZONTAL, false
                            )
                        mViewDataBinding.receiveTripExpertCategoryRecyclerview.adapter = tagAdapter
                        ...
                        Glide.with(MyApplication.instance)
                            ...
                            .into(mViewDataBinding.receiveTripExpertImage)


                        mViewDataBinding.receiveTripExpertDt.text = data[0].reserve_dt
                        mViewDataBinding.receiveTripExpertTime.text =
                            data[0].reserve_time.toString()
                        mViewDataBinding.receiveTripExpertTimezone.text = data[0].reserve_time_term
                        mViewDataBinding.receiveTripExpertHeadcount.text =
                            data[0].reserve_headcount.toString()

                        mViewDataBinding.receiveTripExpertContents.text = data[0].reserve_contents

                        if (data[0].reserve_add_contents != "") {
                            mViewDataBinding.receiveTripExpertAddContentsLayout.visibility =
                                View.VISIBLE
                            mViewDataBinding.receiveTripExpertAddContents.text =
                                data[0].reserve_add_contents
                        }
                        mViewDataBinding.receiveTripFinalPrice.text =
