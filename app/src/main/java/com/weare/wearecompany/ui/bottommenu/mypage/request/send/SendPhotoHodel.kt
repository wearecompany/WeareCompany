...
class SendPhotoHodel(v: View) : RecyclerView.ViewHolder(v) {
    ...
    private val money_title_1 = itemView.findViewById<TextView>(R.id.request_photo_list_money_title_1)
    private val money_title_2 = itemView.findViewById<TextView>(R.id.request_photo_list_money_title_2)
