...
class TripAllDialog(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.addFragment(TripCategoryFragment(), "카테고리")
        adapter.addFragment(TripLocationFragment(), "위치")
        adapter.addFragment(TripMoneyFragment(), "금액대")
        adapter.addFragment(TripSortFragment(), "조회순")
