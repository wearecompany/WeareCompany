...
class SendPhotoViewHodel(v: View) : RecyclerView.ViewHolder(v) {

    private val send_time = itemView.findViewById<TextView>(R.id.send_photo_call_time)
    ...
    private val recyclerView = itemView.findViewById<RecyclerView>(R.id.send_photo_recyclerview)
